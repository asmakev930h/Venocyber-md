...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/3c78edb86b5cc8fc606ee.jpg";
...
global.userImages = process.env.USER_IMAGES || "https://telegra.ph/file/3c78edb86b5cc8fc606ee.jpg";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "great day COBRA MD BOT",
  author: process.env.PACK_AUTHER || "COBRA MD BOT😈💀",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "COBRA MD BOT 😈💀",
  ownername: process.env.OWNER_NAME || "COBRA MD 𝚩𝚯𝚻𝐒 😈💀",
  ...
  LANG: (process.env.THEME || "COBRA MD BOT").toUpperCase(),
};
global.rank = "updated";
